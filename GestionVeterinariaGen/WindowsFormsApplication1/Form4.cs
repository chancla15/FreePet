        ...
        private void button2_Click(object sender, EventArgs e)
        {
           MascotaCEN cen = new MascotaCEN();
            ...
            try
            {
                ...
                cen.New_(m_nombre.Text.ToString(), m_raza.Text.ToString(), sexo, Convert.ToInt32(m_peso.Text.ToString()), m_especie.Text.ToString(), Convert.ToDateTime(m_fecha_nac.Text.ToString()), m_tamanyo.Text.ToString(), M_clienteDNI.Text.ToString(), m_color.Text.ToString(), chip, "");
