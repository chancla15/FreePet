    ...
    class FormAdministradorEmpleadoController
    {
        ...
        public void loadData(EmpleadoEN empleado)
        {
            ...
            if (empleadoEN != null)
            {
                ...
                if (Utils._IVeterinarioCAD.DameVetarinarioPorOID(form.tb_dni.Text) == null)
                {
                    VeterinarioEN vet = new VeterinarioEN();
                    vet=Utils._IVeterinarioCAD.DameVetarinarioPorOID(form.tb_dni.Text);
                    form.tb_tipo.SelectedIndex.Equals(1);
                ...
                else
                {
                    ...
                    form.tb_tipo.SelectedIndex.Equals(0);
                }
                //form.tb_tipo.Text
                Buscar();
            }
        ...
        public void ProcesarInformacion()
        {
                ...
                || (empleadoEN != null && form.state == Utils.State.DESTROY))
            {
                ...
                if (form.tb_tipo.SelectedText.ToString() == "Veterinario")
                {
                    ...
                    switch (form.state)
                    {
                        ...
                        case Utils.State.NEW:
                            Utils._VeterinarioCEN.New_(empleadoEN.DNI, empleadoEN.Nombre, empleadoEN.Apellidos, empleadoEN.Direccion, empleadoEN.Telefono, empleadoEN.Localidad, empleadoEN.Provincia, empleadoEN.Cp, empleadoEN.Sueldo, empleadoEN.Password, Convert.ToInt32(form.tb_colegiado));
                            break;
                        case Utils.State.MODIFY:
                            Utils._VeterinarioCEN.Modify(empleadoEN.DNI, empleadoEN.Nombre, empleadoEN.Apellidos, empleadoEN.Direccion, empleadoEN.Telefono, empleadoEN.Localidad, empleadoEN.Provincia, empleadoEN.Cp, empleadoEN.Sueldo, empleadoEN.Password, Convert.ToInt32(form.tb_colegiado));
                            break;
