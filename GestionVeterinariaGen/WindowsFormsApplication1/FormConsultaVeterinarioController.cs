...
namespace WindowsFormsApplication1
{
     ...
     */
    class FormConsultaVeterinarioController
    {
        /** La vista */
        FormConsultaVeterinario form;
         ...
         */
        public FormConsultaVeterinarioController(FormLoginDataSessionTicket session, FormConsultaVeterinario form)
        {
            this.form = form;
