...
public void Modify (string p_Empleado_OID, string p_nombre, string p_apellidos, String p_password, string p_direccion, string p_telefono, string p_localidad, string p_provincia, string p_cp, string p_IdEmpleado, float p_sueldo)
{
        EmpleadoEN empleadoEN = null;
