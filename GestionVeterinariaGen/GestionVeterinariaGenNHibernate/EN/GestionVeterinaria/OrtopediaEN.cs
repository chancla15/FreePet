...
public OrtopediaEN(string nombre, string talla, int longitud, string fecha, string duracion, System.Collections.Generic.IList<GestionVeterinariaGenNHibernate.EN.GestionVeterinaria.ConsultaEN> consulta, float precio, System.Collections.Generic.IList<GestionVeterinariaGenNHibernate.EN.GestionVeterinaria.FacturaEN> factura)
{
        this.init (nombre, talla, longitud, fecha, duracion, consulta, precio, factura);
}


public OrtopediaEN(OrtopediaEN ortopedia)
{
        this.init (ortopedia.Nombre, ortopedia.Talla, ortopedia.Longitud, ortopedia.Fecha, ortopedia.Duracion, ortopedia.Consulta, ortopedia.Precio, ortopedia.Factura);
}

private void init (string nombre, string talla, int longitud, string fecha, string duracion, System.Collections.Generic.IList<GestionVeterinariaGenNHibernate.EN.GestionVeterinaria.ConsultaEN> consulta, float precio, System.Collections.Generic.IList<GestionVeterinariaGenNHibernate.EN.GestionVeterinaria.FacturaEN> factura)
{
        this.Nombre = nombre;
